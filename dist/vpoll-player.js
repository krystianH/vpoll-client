...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";function vPollPlayer(e,t){if(!t.socketUrl)throw new Error("options.socketUrl needs to be specified");var a=window.socket=_socketIoClient2["default"](t.socketUrl);a.on("message",function(e){return console.log(e)});var r=_videoJs2["default"](e,t),l=new _videoJs2["default"].Chart(r,t),o=(r.addChild(l),document.getElementById("myChart").getContext("2d"));return window.barChart=new _chartJs2["default"](o).Bar(window.chartdata,window.chartoptions),r}var _Object$defineProperty=__webpack_require__(1)["default"],_interopRequireDefault=__webpack_require__(5)["default"];_Object$defineProperty(exports,"__esModule",{value:!0}),exports["default"]=vPollPlayer;var _videoJs=__webpack_require__(6),_videoJs2=_interopRequireDefault(_videoJs),_socketIoClient=__webpack_require__(9),_socketIoClient2=_interopRequireDefault(_socketIoClient),_chartJs=__webpack_require__(61),_chartJs2=_interopRequireDefault(_chartJs);__webpack_require__(62),__webpack_require__(70),window.chart=window.chart||_chartJs2["default"],window.vjs=window.vjs||_videoJs2["default"],window.videojs=window.videojs||_videoJs2["default"],window.vPollPlayer=vPollPlayer,window.chartdata={labels:["Petter","Ashkan"],datasets:[{label:"Vem vinner matchen?",fillColor:"rgba(220,220,220,0.5)",strokeColor:"rgba(220,220,220,0.8)",highlightFill:"rgba(220,220,220,0.75)",highlightStroke:"rgba(220,220,220,1)",data:[65,59]}]},window.chartoptions=[],_chartJs2["default"].defaults.global.scaleBeginAtZero=!0,_chartJs2["default"].defaults.global.scaleSteps=5,_chartJs2["default"].defaults.global.scaleStepWidth=20,_chartJs2["default"].defaults.global.scaleStartValue=0,_chartJs2["default"].defaults.global.scaleOverride=!0,_chartJs2["default"].defaults.global.scaleLabel="<%=value%>%",module.exports=exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(){
		...
		var each = helpers.each = function(loopable,callback,self){
			...
			amd = helpers.amd = ("function" == 'function' && __webpack_require__(17)),
			//-- Math methods
